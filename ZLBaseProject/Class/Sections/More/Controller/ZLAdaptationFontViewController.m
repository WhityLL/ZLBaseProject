//
//  ZLAdaptationFontViewController.m
//  ZLBaseProject
//
...
#import "ZLAdaptationFontViewController.h"

@interface ZLAdaptationFontViewController ()

@end

@interface ZLAdaptationFontViewController()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic,strong) NSArray             *dataArray;
@property (nonatomic,strong) UITableView         *myTableView;
@end


@implementation ZLAdaptationFontViewController
...
- (void)viewDidLoad {
    ...
    if (!_myTableView) {
        _myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0,0.5, SCREEN_WIDTH, SCREENH_HEIGHT) style:UITableViewStylePlain];
