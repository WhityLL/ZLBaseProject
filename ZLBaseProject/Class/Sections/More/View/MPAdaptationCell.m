...
-(void)LayoutLayoutCell
{
    if (!self.myDateLabel) {
        ...
        self.myDateLabel.font=AdaptedFontSize(12);
        ...
        self.myDateLabel.backgroundColor = ZLRandomColor;
    }
    ...
    if (!self.myTextLabel) {
        ...
        self.myTextLabel.backgroundColor = ZLRandomColor;
    }
}
...
{
    CGFloat result=3*AdaptedHeight(KTopSpace)+AdaptedHeight(12);
    if (text.length>0) {
